> Source title: Astar Island — Viking Civilisation Prediction  
> Source URL: https://app.ainm.no/docs/astar-island/overview  
> Imported: 2026-03-20
...
![Initial Astar Island Map](./assets/map-initial.png)
...
![Same map, different stochastic outcomes](./assets/stochastic-outcomes.png)

![Viewport: you only see a small window of the full map](./assets/viewport-demo.png)
