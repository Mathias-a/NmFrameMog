> Source title: Astar Island Simulation Mechanics  
> Source URL: https://app.ainm.no/docs/astar-island/mechanics  
> Imported: 2026-03-20
...
![Terrain Types](./assets/terrain-types.png)
...
![Simulation Phases](./assets/simulation-phases.png)
...
![Faction dynamics — settlements change color as allegiances shift](./assets/faction-dynamics.gif)
...
![50-year simulation](./assets/simulation.gif)

Initial state vs. after 50 years of simulation:

![Before and after](./assets/simulation-before-after.png)

With high expansion, settlements rapidly colonise available land:

![High expansion simulation](./assets/expansion.gif)
