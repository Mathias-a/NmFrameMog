> Source title: Astar Island Scoring  
> Source URL: https://app.ainm.no/docs/astar-island/scoring  
> Imported: 2026-03-20
...
![Probability tensor — per-cell class probabilities](./assets/probability-tensor.png)
...
Round weights increase over time (`1.05^round_number`), so a good score on a later round counts for more. Only your single best weighted result matters — keep improving your model across rounds.
...
4. Leaderboard updates with best weighted score
