> Source title: API Endpoint Specification  
> Source URL: https://app.ainm.no/docs/astar-island/endpoint  
> Imported: 2026-03-20
...
Public endpoints are marked **Public** below. Team endpoints require authentication. The API accepts either:
...
![Viewport: full map with highlighted window vs. what gets returned](./assets/viewport-demo.png)
