...
def test_output_shape(strategy: MCOracleStrategy, first_initial_state: InitialState) -> None:
    ...
    result = strategy.predict(first_initial_state, budget=5, base_seed=0)
...
def test_deterministic_with_same_seed(
    ...
    r1 = strategy.predict(first_initial_state, budget=5, base_seed=42)
    r2 = strategy.predict(first_initial_state, budget=5, base_seed=42)
...
def test_different_seeds_produce_different_results(
    ...
    r1 = strategy.predict(first_initial_state, budget=5, base_seed=0)
    r2 = strategy.predict(first_initial_state, budget=5, base_seed=12345)
