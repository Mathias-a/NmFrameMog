...
class MCOracleStrategy:
    ...
    ``budget * 4`` simulations per seed.  It is intended as a score ceiling
    to validate that the harness and scoring pipeline work correctly.  It is
    NOT a fair competitor and should not be compared directly to real
    strategies.
    """
